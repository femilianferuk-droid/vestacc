...
def init_db():
    ...
    with db.cursor() as cur:
        ...
        cur.execute("CREATE TABLE IF NOT EXISTS purchases (id SERIAL PRIMARY KEY, buyer_id INTEGER REFERENCES users(id), account_id REFERENCES accounts(id), phone_number VARCHAR(20), purchase_date TIMESTAMP DEFAULT NOW(), code_retrieved BOOLEAN DEFAULT FALSE)")
...
def navbar():
    if g.user:
        ...
        <div class="sidebar" id="sidebar">
            <a href="/profile" onclick="closeSidebar()">Профиль</a>
            <a href="/my_purchases" onclick="closeSidebar()">Мои покупки</a>
        </div>
        '''
