...
SCRIPT = '''
<script>
function toggleSidebar(){var s=document.getElementById('sidebar');var o=document.getElementById('overlay');var b=document.getElementById('burger');s.classList.toggle('open');o.classList.toggle('show');b.classList.toggle('open')}
...
def deposit():
    if request.method == 'POST':
        ...
        if amount < 20: flash('Минимум 20 ₽', 'error')
            ...
            try:
                # Правильный запрос к Crypto Pay API
