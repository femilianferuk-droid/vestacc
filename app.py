...
.purchase-card, .my-acc-card { background: #161622; border: 1px solid rgba(255,255,255,0.03); border-radius: 18px; padding: 18px; margin-bottom: 12px; }
...
def footer():
    ...
    <div class="footer">
        <div class="footer-content">
            <div class="footer-brand">Vest Accs 2026</div>
