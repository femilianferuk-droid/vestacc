...
def account_detail(account_id):
    try:
        ...
        # ОБНОВЛЕННЫЙ БЛОК КНОПОК: теперь они рядом!
        action_buttons = ''
...
def profile():
    ...
    # УЛУЧШЕННЫЙ ПРОФИЛЬ С ТАБАМИ
    content = f'''
    <div class="profile-section">
        <div class="profile-header">
            <div class="avatar-xl">V</div>
            <div class="profile-info">
                <h3>{g.user["username"]} <span class="rating-badge">★ {rating_str}</span></h3>
