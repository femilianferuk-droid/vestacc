...
<div class="form-box" style="max-width:700px">
    <h2 style="margin-bottom:6px">FAQ — Частые вопросы</h2>
    <p style="color:var(--text-muted);margin-bottom:20px;font-size:13px">Ответы на популярные вопросы</p>
    <div style="display:flex;flex-direction:column;gap:16px">
        <div class="info-block"><div class="info-label">Как купить аккаунт?</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Пополните баланс, выберите аккаунт на главной и нажмите «Купить». После оплаты аккаунт появится в разделе «Мои покупки».</p></div>
        <div class="info-block"><div class="info-label">Как войти в купленный аккаунт?</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Скачайте сессию Telethon или JSON, используйте полученный код из Telegram. При проблемах — обратитесь в поддержку.</p></div>
        <div class="info-block"><div class="info-label">Как продать аккаунт?</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">В боковом меню нажмите «Продать аккаунт», введите номер телефона аккаунта, подтвердите вход и заполните данные объявления.</p></div>
        <div class="info-block"><div class="info-label">Как вывести средства?</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Минимум 50 ₽, нужна хотя бы 1 продажа. Укажите адрес TON кошелька в разделе «Вывод средств».</p></div>
        <div class="info-block"><div class="info-label">Что такое спamblock и как его проверить?</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Спамблок — ограничение Telegram на отправку сообщений. Аккаунты без спамблока ценятся выше. Проверяется автоматически.</p></div>
        <div class="info-block"><div class="info-label">Что делать если аккаунт невалид?</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Перед покупкой нажмите «Проверить на валид». Если аккаунт уже куплен и не работает — <a href="https://t.me/VestAccsSupport" class="support-link" target="_blank">напишите в поддержку</a>.</p></div>
    </div>
</div>
'''
...
RULES_HTML = '''
<div class="form-box" style="max-width:700px">
    <h2 style="margin-bottom:6px">Правила сервиса</h2>
    <p style="color:var(--text-muted);margin-bottom:20px;font-size:13px">Используя Vest Accs, вы соглашаетесь с данными правилами</p>
    <div style="display:flex;flex-direction:column;gap:16px">
        <div class="info-block"><div class="info-label">1. Запрещённые действия</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Запрещено продавать аккаунты, полученные незаконным путём (взлом, фишинг с ущербом). Запрещено мошенничество и обман других пользователей.</p></div>
        <div class="info-block"><div class="info-label">2. Возвраты</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Возврат средств возможен только если аккаунт не соответствует описанию. Заявки рассматриваются администрацией в индивидуальном порядке.</p></div>
        <div class="info-block"><div class="info-label">3. Комиссия сервиса</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Комиссия за продажу составляет 5% от цены аккаунта. Пополнение без комиссии через Crypto Bot.</p></div>
        <div class="info-block"><div class="info-label">4. Вывод средств</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Минимальная сумма вывода — 50 ₽. Необходима минимум 1 успешная продажа. Выводы обрабатываются администратором.</p></div>
        <div class="info-block"><div class="info-label">5. Ответственность</div><p style="font-size:13px;color:var(--text-secondary);margin-top:4px">Администрация не несёт ответственности за действия третьих лиц. Все споры решаются путём переговоров с участием администрации.</p></div>
...
:root {
    ...
    --bg-card: #16161f;
    --bg-hover: #1c1c28;
    --border: rgba(42, 171, 238, 0.06);
    --border-active: rgba(42, 171, 238, 0.15);
    --text: #f1f5f9;
...
body.light {
    ...
    --border-active: rgba(42,171,238,0.2);
    --text: #0f172a;
...
.theme-toggle{
    width:36px;height:36px;background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);
...
.sidebar{
    position:fixed;top:0;right:0;width:250px;height:100vh;background:var(--bg-secondary);
    border-left:1px solid var(--border);z-index:101;
    transition:transform 0.35s cubic-bezier(0.4,0,0.2,1);
    padding:85px 16px 20px;display:flex;flex-direction:column;gap:6px;
...
.sidebar a{
    ...
    font-weight:500;transition:0.2s;font-size:13px;border:1px solid transparent
}
...
.card{
    ...
    border-radius:var(--radius-lg);padding:18px;transition:all 0.25s ease
}
...
.account-card-compact{
    ...
    background:var(--bg-card);border:1px solid var(--border);
    border-radius:var(--radius);padding:14px 18px;transition:all 0.2s ease;
    gap:16px
}
...
.profile-header{
    ...
    border:1px solid var(--border);border-radius:var(--radius-lg);padding:28px;margin-bottom:24px
}
...
.profile-stats .stat{
    ...
    border-radius:var(--radius);padding:14px;text-align:center;cursor:pointer;transition:0.2s
}
...
.purchase-card{
    background:var(--bg-card);border:1px solid var(--border);
    border-radius:var(--radius-lg);padding:22px;margin-bottom:14px;animation:fadeInUp 0.3s ease;cursor:pointer;transition:0.2s
}
...
.purchase-preview .preview-tag{
    padding:3px 8px;border-radius:20px;font-size:10px;font-weight:600;
    background:rgba(42,171,238,0.06);border:1px solid var(--border-active);
...
.code-box{
    ...
    font-family:monospace;font-size:16px;color:var(--primary-light);margin-top:8px;letter-spacing:2px
}
...
.auth-card{
    ...
    max-width:400px;animation:fadeInUp 0.5s ease
}
...
@media(max-width:768px){
    ...
    .account-card-compact{padding:12px 14px;gap:10px}
    .acc-title{font-size:13px}
    .acc-tag{font-size:9px;padding:2px 6px}
    .acc-price{font-size:14px}
    .profile-header{padding:20px}
    .profile-header .balance{font-size:24px}
...
def download_session(pid):
    try:
        ...
        try:
            ...
            c.execute('INSERT INTO sessions VALUES (?, ?, ?, ?, ?)', (session_obj.dc_id, session_obj.server_address, session_obj.port, auth_key_bytes, 0))
            conn.commit()
            conn.close()
            db = get_db()
            with db.cursor() as cur:
...
def account_detail(account_id):
    try:
        ...
        <div style="display:flex;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:20px">
            <div><h2 style="font-size:22px;font-weight:800">{a["title"]}</h2><p style="color:var(--text-muted);font-size:13px;margin-top:4px">Продавец: <strong style="color:var(--primary-light)">{a["seller_name"]}</strong> {rating_html}</p></div>
            <div style="background:rgba(16,185,129,0.06);border:1px solid rgba(16,185,129,0.15);padding:10px 20px;border-radius:var(--radius);text-align:center"><div style="font-size:20px;font-weight:900;color:var(--success)">{a["price"]:.2f} ₽</div></div>
        </div>
        <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:16px">{check_btn}{buy_btn}</div>
        ...
        <div style="background:rgba(255,255,255,0.01);border:1px solid var(--border);border-radius:var(--radius);padding:14px"><p style="font-size:13px;color:var(--text-secondary)">{a["description"] or "Описание отсутствует."}</p></div>
        </div></div>{footer()}'''
        ...
        for p in purchases:
                ...
                <div class="purchase-detail">
                    <div class="purchase-info">
                        <div class="info-block">
                            ...
                            <button class="btn-copy" data-copy="{p["phone_number"]}" style="margin-top:8px">Копировать</button>
                        </div>
                        <div class="info-block">
                            <div class="info-label">DC ID</div>
                            <div class="info-value">{dc_id}</div>
                            <button class="btn-copy" data-copy="{dc_id}" style="margin-top:8px">Копировать</button>
                        </div>
                        <div class="info-block">
                            <div class="info-label">AUTH KEY</div>
                            <div class="info-value mono">{auth_key_short}</div>
                            <button class="btn-copy" data-copy="{auth_key_str}" style="margin-top:8px">Копировать</button>
                        </div>
                    </div>
            ...
            <div class="modal" id="win-review-{p["id"]}">
                <div class="modal-content">
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px"><h3>Оставить отзыв</h3><button class="window-close" style="background:transparent;border:none;color:var(--text-muted);font-size:22px;cursor:pointer">&times;</button></div>
                    <form method="POST" action="/review/{p["id"]}">
                        <p style="text-align:center;color:var(--text-muted);margin-bottom:8px">Оцените продавца</p>
...
def profile():
    ...
    <div class="modal" id="win-stats">
        <div class="modal-content">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px"><h3>Детальная статистика</h3><button class="window-close" style="background:transparent;border:none;color:var(--text-muted);font-size:22px;cursor:pointer">&times;</button></div>
    ...
    <div class="modal" id="win-sell">
        <div class="modal-content">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px"><h3>Продать аккаунт</h3><button class="window-close" style="background:transparent;border:none;color:var(--text-muted);font-size:22px;cursor:pointer">&times;</button></div>
            <form method="POST">
    ...
    <div class="modal" id="win-withdraw">
        <div class="modal-content">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px"><h3>Вывод средств</h3><button class="window-close" style="background:transparent;border:none;color:var(--text-muted);font-size:22px;cursor:pointer">&times;</button></div>
