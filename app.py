...
def navbar():
    if g.user:
        admin_link = '<div style="height:1px; background:rgba(255,255,255,0.06); margin:6px 0;"></div><a href="/admin">Админ-панель</a>' if g.user.get("is_admin") else ''
        return f'''
        <div class="navbar">
...
@login_required
def profile():
    # Если в сессии висят данные верификации — уводим на «отдельное окно» ввода кода
...
def verify_code_page():
    ...
    # Сборка формы ("Окна") ввода кода в зависимости от шага (Обычный код / 2FA Пароль)
